...
jQuery(document).ready(function ($) {
    var Video_back = new video_background($("#home"), {
        ...
        "mp4": "vendor/upload/preview.mp4",     //Path to video mp4 format
        "ogg": "vendor/upload/preview.ogg",     //Path to video ogg format
        "webm": "vendor/upload/preview.webm",     //Path to video webm format
