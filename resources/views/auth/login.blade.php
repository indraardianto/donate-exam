          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              <div class="brand-logo">
                <img style="width: 20%" src="{{asset('main')}}/images/logo-mini.svg" alt="logo">
              </div>
              <h4>Selamat Datang,</h4>
              <h6 class="font-weight-light mb-4">Di Portal Aplikasi Edulogi Charity</h6>
              <form method="POST" action="{{ route('login') }}">
                @csrf
                ...
                <div class="my-3">
                  <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="{{asset('main')}}/index.html">LOGIN</button>
                </div>
              </form>
            </div>
          </div>
